...
cd /workspace/runpod-slim/ComfyUI/custom_nodes/ComfyUI-FlashVSR_Ultra_Fast && pip install -r requirements.txt
cd /workspace/runpod-slim/ComfyUI/custom_nodes/ComfyUI-SCAIL-Pose && pip install -r requirements.txt
cd /workspace/runpod-slim/ComfyUI/custom_nodes/ComfyUI-WanAnimatePreprocess && pip install -r requirements.txt
